...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&pause=1000&color=2E9EF7&vCenter=true&width=550&lines=PhD+Candidate+%7C+Hong+Kong;Nanopore+RNA+Modification+Detection;Bioinformatics+%2B+Deep+Learning;Reproducible+Research+Enthusiast)](https://git.io/typing-svg)
...
- 🔬 PhD candidate based in **Hong Kong**, researching **RNA modification detection from Nanopore direct RNA sequencing**
...
- 🐍 Primary languages: **Python**, **R**, **C** — daily driver of Jupyter, Snakemake, and Docker
- 🌱 Currently exploring **deep learning for genomics** and **LLM applications in scientific writing**
...
**Research Domains:**
![Nanopore Sequencing](https://img.shields.io/badge/Nanopore_Sequencing-6A1B9A?style=flat-square)
![RNA Modifications](https://img.shields.io/badge/RNA_Modifications-00897B?style=flat-square)
![Deep Learning](https://img.shields.io/badge/Deep_Learning-FF6F00?style=flat-square)
![Bioinformatics](https://img.shields.io/badge/Bioinformatics-1565C0?style=flat-square)
...
| Project | Description |
|---------|-------------|
| [**ModNet**](https://github.com/loganylchen/modnet) | Multi-task deep learning for RNA modification detection from Nanopore DRS |
| [**pybaleen / Baleen**](https://github.com/loganylchen/pybaleen) | RNA modification detector based on Nanopore direct-RNA-seq |
| [**RealFusionSimulator**](https://github.com/loganylchen/RealFusionSimulator) | A real fusion simulator for benchmarking |
| [**scSpliceAtlas**](https://github.com/loganylchen/scSpliceAtlas) | Single-cell splice variant atlas |
| [**MoonFinder3**](https://github.com/loganylchen/MoonFinder3) | Gene fusion detection tool |
| [**RNA-seq-is-everything**](https://github.com/loganylchen/RNA-seq-is-everything) | RNA-seq analysis resources |
| [**opencode-scientific-writer**](https://github.com/loganylchen/opencode-scientific-writer) | OpenCode plugin for scientific writing |
...
<div align="center">
  <img src="https://komarev.com/ghpvc/?username=loganylchen&color=blue&style=flat-square" alt="Profile Views"/>
</div>
